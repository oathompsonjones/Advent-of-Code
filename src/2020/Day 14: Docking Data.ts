...
for (const line of input) {
    ...
    if (line.startsWith("mem")) {
        const [index] = line.slice(4).split("]") as [string];
        const value = parseInt(line.split(" = ")[1]!, 10).toString(2)
        ...
        mem[parseInt(index, 10)] = parseInt(value.join(""), 2);
    }
}
...
console.log([...memMap.values()].reduce((a: string, b: string) => a + b));
